...
public class CorsConfiguration {
  ...
  private static final String ALLOWED_HEADERS = "user-ws-session-id, x-requested-with, authorization, Content-Type, Content-Length, Authorization, credential, X-XSRF-TOKEN";
